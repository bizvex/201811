classdef UE < handle
    ...
    methods
        ...
        function get_MBS_SINR_FFRA_after(obj,config)
            ...
            obj.MBS_SINR_after = 10*log10(signal_power*invdB(obj.MBS_ser_BF)/...
            (MBS_interference_power+UAV_interference_power*invdB(obj.UAV_in_BF)/invdB(config.ACIR)+noise_power));
        end
        
        function get_UAV_SINR_FFRA(obj,config,d_2d,this_UAV,otherUAV)
            ...
            obj.UAV_SINR = 10*log10(signal_power*invdB(obj.UAV_ser_BF)/... 
            (MBS_interference_power*invdB(obj.MBS_in_BF)/invdB(config.ACIR)+noise_power));
        end
